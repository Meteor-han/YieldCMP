...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls):
        if True:
            ...
            bert_name = '/amax/data/group_0/3D-MoLM/scibert_scivocab_uncased'
        else:
    ...
    def init_unimol_encoder(cls, args):
        dictionary = Dictionary.load('/home/group_0/3D-MoLM-main/data_provider/unimol_dict.txt')  # './data_provider/unimol_dict.txt'
        dictionary.add_symbol("[MASK]", is_special=True)
        unimol_model = SimpleUniMolModel(args, dictionary)
        ckpt = torch.load('/amax/data/xx/reaction_mvp/conformer/UniMol/weights/mol_pre_no_h_220816.pt', map_location=torch.device('cpu'))['model']
    ...
    def init_graph_encoder(
        ...
        ckpt = torch.load('all_checkpoints/graphcl_80.pth', map_location=torch.device('cpu'))
